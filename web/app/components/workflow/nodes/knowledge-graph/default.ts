...
import { CodeLanguage, type KnowledgeGraphNodeType } from './types'
import { ALL_CHAT_AVAILABLE_BLOCKS, ALL_COMPLETION_AVAILABLE_BLOCKS } from '@/app/components/workflow/constants'

const i18nPrefix = 'workflow.errorMsg'

const nodeDefault: NodeDefault<KnowledgeGraphNodeType> = {
  defaultValue: {
    code: '',
  ...
  checkValid(payload: KnowledgeGraphNodeType, t: any) {
    let errorMessages = ''
